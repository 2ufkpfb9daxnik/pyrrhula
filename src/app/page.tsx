...
export default function LandingPage() {
  return (
    <div className="flex min-h-screen bg-background">
      {/* 左側：ランディングページ */}
      <div className="fixed left-0 flex h-screen w-1/2 flex-col items-center justify-center p-4">
      ...
      {/* 右側：タイムライン */}
      <div className="ml-[50%] min-h-screen w-1/2 border-l border-gray-800">
        <WholeTimeline />
      </div>
    </div>
  );
